...
DATABASES = {
    'default': {
        ...
        'HOST': 'arrowdb.cpzb4jp3x0uy.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'arrowblog' # please enter your s3 bucket name
